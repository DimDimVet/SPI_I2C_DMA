#include "init_SPI.h"
#define SIZE 3
uint8_t sizeBufRxSPI=100;
uint32_t dataBufRxSPI[100];
...
void Config_SPI1()//master mode
{
    ...
    SPI2->CR1 |= 1 << SPI_CR1_LSBFIRST_Pos;//Формат кадра LSB0
...
void Config_SPI1_DMA1()
{
    ...
    DMA1_Stream3->NDTR = sizeBufRxSPI;//размер массива
...
//		for(int i=0; i < 30; i++)
//		{
//			str_data1[i]=str_data[i];
//		}

    DMA1_Stream4->CR &= ~DMA_SxCR_EN;
    DMA1_Stream4->NDTR = 30;		
