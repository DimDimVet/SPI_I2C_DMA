...
///////////////////////////////
int I2C_DMA_TransmitReceive1(uint16_t DevAddress,uint8_t *pData,uint16_t Size)
{
		...
		while (Size > 0U)
    {
				   // DMA1_Stream6->CR &= ~DMA_SxCR_EN;
						DMA1_Stream6->NDTR = 1;		
						DMA1_Stream6->M0AR = (uint32_t)pData; // Указание адреса буфера передачи
...
int Read_I2C_DMA1(uint16_t DevAddress,uint8_t *pData,uint16_t Size)
{
...
//          }
                ...
                I2C1->CR1 |=1 << I2C_CR1_STOP_Pos;
								    ...
								    DMA1_Stream5->M0AR = (uint32_t)pData;
